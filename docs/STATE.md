...
semantic search/AI arama tamamen Faz 3'e çekildi (MVP arama yalnızca yapısal filtre), WhatsApp paylaşım
...
- Semantic search/pgvector (MVP'de, ilk tasarım): ELENDİ → Faz 3'e alındı. Gerekçe: Codex — birkaç yüz
  mekanlık veri setinde gereksiz karmaşıklık ("mühendislik kostümü"); kullanıcı MVP'de tamamen yapısal
  filtreyi tercih etti. KOŞULLU — Faz 3'te mekan sayısı büyüyünce yeniden değerlendir.
