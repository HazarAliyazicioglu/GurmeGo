...
**Alarmlar:** API 5xx oranı, p95 gecikme > 500 ms (NFR-02 marjı), günlük AI harcaması eşik aşımı (NFR-05), kürasyon kuyruğu bekleme > 72 saat (SLA).
...
| Expo EAS | $0 |
| Sentry/uptime | $0 |
| LLM (Haiku, cache'li ~binlerce sorgu/ay) | ~$1-5 |
| Embedding (yüzlerce mekan + sorgular) | < $1 |
| **Toplam** | **~$6-40/ay** ✅ bütçe içinde |

Ölçek tetikleyicileri: Supabase Pro (DB > 500 MB veya günlük aktif > ~1K), Redis ekleme (rate limit sayaç yükü), Railway ölçekleme (p95 bozulunca).
