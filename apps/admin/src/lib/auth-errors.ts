// Supabase Auth returns English messages; curators see Turkish. Same list as apps/web's and
// apps/mobile's lib/auth-errors.ts (duplicated, not shared -- matches this repo's existing
// per-app duplication of small auth/api helpers).
